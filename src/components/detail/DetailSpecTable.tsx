...
export interface DetailSpecTableProps {
  safeLocation: string;
  safeMake?: string;
  safeModel?: string;
  safeYear: string;
...
export const DetailSpecTable: React.FC<DetailSpecTableProps> = ({
  safeLocation,
  safeMake,
  safeModel,
  safeYear,
  ...
  return (
    <div className={`grid grid-cols-1 md:grid-cols-2 gap-x-8 lg:gap-x-12 gap-y-2 text-xs lg:text-sm ${className}`}>
      {/* Sol Sütun */}
